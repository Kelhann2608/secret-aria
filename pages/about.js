      ...
      <div className="min-h-screen ">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex justify-center lg:my-10">
            <Image
              className="mt-10 shadow-xl top-100 md:w-96 md:h-96 lg:ml-64 rounded-xl shadow-purple-800/50 "
              src={Jess}
          ...
          <div className="flex flex-col flex-wrap content-center mx-4 lg:w-2/4 lg:mb-6">
            <h1 className="mt-10 mb-3 text-lg text-center underline font-DancingS text-fuchsia-500 underline-offset-8 lg:text-3xl">A propos</h1>
            <p className="mx-3 mb-5 font-semibold text-justify font-DancingS lg:text-3xl lg:text-justify lg:mx-4 md:text-2xl md:mx-4 ">Secret'Aria est le spécialiste de la gestion administrative.
