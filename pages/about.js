      ...
      <div className="min-h-screen ">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex justify-center lg:my-5">
            <Image
              className="mt-10 top-100 md:w-96 md:h-96 lg:ml-64"
              src={Jess}
              width={290}
              height={292}
          ...
          <div className="flex flex-col flex-wrap content-center mx-4 lg:w-2/4 lg:mb-6">
            ...
            <p className="mx-3 mb-5 text-justify font-DancingS lg:text-3xl lg:text-justify lg:mx-4">Secret'Aria est le spécialiste de la gestion administrative.
